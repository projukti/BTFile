    ...
    <table>
        ...
        <!--repeat-->
            ...
            <?php if($soc==true AND $crm==false) { ?><video controls preload="none">
               <source src="video_upload/<?php echo $fetch['file_name'];?>" type="video/mp4">
                    Your browser does not support the video tag.
			</video> <?php } else {?>
			<embed type="application/x-vlc-plugin" pluginspage="http://www.videolan.org" src="video_upload/<?php echo $fetch['file_name'];?>" width="300" height="250" autoplay="false" autostart="0" />
			<?php } ?>
            </td>
            <td width="50%" style="text-align: center">
                <a href="video_upload/<?php echo $fetch['file_name'];?>"><?php echo $fetch['file_name'];?></a>
            </td>
            </tr>
            <?php }//}?>
